...
internal object TestUtil {
    ...
    fun folder(closure: Path.() -> Unit) = createTempDirectory("protelisdoc-test").apply {
        makeSettingsFile()
    ...
    fun Path.file(name: String, content: () -> String) = resolve(name).createFile().writeText(content().trimIndent())

    fun runGradleTask(workingDirectory: Path, task: String) {
