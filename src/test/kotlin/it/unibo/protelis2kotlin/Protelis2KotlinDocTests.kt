...
class Protelis2KotlinDocTests : StringSpec({
    ...
    val workingDirectory = folder {
        ...
        File("""${this.root.absoluteFile.absolutePath}${SEP}src${SEP}main${SEP}protelis${SEP}file.java""")
            .writeText(
                """
                    /** prova
                    */
        ...
        File("${this.root.absolutePath}${SEP}src${SEP}main${SEP}protelis${SEP}collect.pt")
            .writeText(
                """
        ...
        File("${this.root.absolutePath}${SEP}src${SEP}main${SEP}protelis${SEP}file.pt")
            .writeText(
                """
