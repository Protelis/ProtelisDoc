 ...
 */
private data class DocParam(val name: String, val type: String, val description: String) : DocPiece {
 ...
 */
private data class DocReturn(val returnType: String, val description: String) : DocPiece {
 ...
 */
private data class DocDirective(val directive: String, val description: String) : DocPiece {
 ...
 * @return [ProtelisFun]
 */
private fun parseProtelisFunction(fline: String): ProtelisFun = ProtelisFun(
    name =
 ...
 */
private fun generateKotlin(context: Context, protelisItems: List<ProtelisItem>): String = protelisItems
    .map { item ->
        val doc = item.docs
 ...
 */
private fun packageToClassName(pkg: String): String = pkg
    .split(':')
    .last()
    .split('_')
...
private fun String.sha256(): String = BigInteger(MessageDigest.getInstance("SHA-256").digest(toByteArray()))
    .toString(36)
